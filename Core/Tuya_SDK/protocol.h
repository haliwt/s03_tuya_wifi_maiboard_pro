...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "faw0t5mfdd4wdgpf"    //开发平台创建产品后生成的16位字符产品唯一标识  -tuya APP"衣柜护理机"
//#define PRODUCT_KEY   "zivxwtzw0adtg0jg"    //"UYJ05" tuya APP “鞋柜护理机”                       
...
#define WIFIR_UART_SEND_BUF_LMT         50              //根据用户DP数据大小量定,必须大于48
/******************************************************************************
                        4:定义模块工作方式
模块自处理:
...
******************************************************************************/
#define         SUPPORT_MCU_RTC_CHECK                //开启校时功能 //WT.EDIT 2023.02.22
