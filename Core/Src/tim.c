...
void MX_TIM1_Init(void)
{
  ...
  htim1.Init.Period = 39; // F = 1/(39+1) = 0.025MHz= 25KHz
...
void MX_TIM14_Init(void)
{
  ...
  htim14.Init.Period = 499;//F = 1/(1+999)=2KHz
...
/* TIM16 init function */
void MX_TIM16_Init(uint8_t period,uint8_t duty)
{
  ...
  htim16.Init.Period = 9; //65535; 100KHz
